 ...
 * same config/logging/database/queue/storage foundation as the API process.
 */
@Module({
  imports: [ConfigModule, LoggingModule, DatabaseModule, QueueModule, StorageModule, OrchestratorWorkerModule],
})
